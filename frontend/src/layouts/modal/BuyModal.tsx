import {
  ...
  export const  BuyModal:React.FC<BuyModalPropsType>=({children,product ,quantity})=> {
        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
              <div className={styles.buyBox}>
                  ...
                  <button className={styles.confirButton} onClick={handleBuy}> Confirm Now </button>
              </div>
          </ModalContent>
        </Modal>
      </>
